...
export const MENU = {
  ...
  lanches: [{ name: "Calzone", price: 35, hasFlavors: true, flavorsKey: "calzoneFlavors" },{ name: "Mini-Pizza", price: 17, hasFlavors: true, flavorsKey: "miniPizzaFlavors" },{ name: "Macarronada de Carne", sizes: [{ code: "P", price: 28 },{ code: "M", price: 40 },{ code: "G", price: 50 }], hasFlavors: false, price: 0, flavorsKey: "" },{ name: "Macarronada de Frango", sizes: [{ code: "P", price: 28 },{ code: "M", price: 40 },{ code: "G", price: 50 }], hasFlavors: false, price: 0, flavorsKey: "" },{ name: "X-Burguer", price: 15, hasFlavors: false, flavorsKey: "" },{ name: "X-Bacon", price: 18, hasFlavors: false, flavorsKey: "" },{ name: "X-Tudo", price: 22, hasFlavors: false, flavorsKey: "" },{ name: "Porcao de Batatas", price: 12, hasFlavors: false, flavorsKey: "" }] as { name: string; price: number; hasFlavors: boolean; flavorsKey: string; sizes?: { code: string; price: number }[] }[],
