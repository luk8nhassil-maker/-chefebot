  ...
  return (
    <>
      ...
      <style>{`
        ...
        .cbn-item.active .cbn-icon-circle{width:42px;height:42px;background:var(--primary);color:var(--primary-foreground);transform:translateY(3px);box-shadow:0 3px 8px rgba(0,0,0,.16), 0 0 0 3px var(--surface)}
