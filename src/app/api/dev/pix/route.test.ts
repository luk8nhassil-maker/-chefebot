...
const painelFixture = {
  ...
  origem: { webhook: 1, manual: 1, conciliador_mercadopago: 0, identificadasPeloSentinelaDesdeVersao: 0 },
  ...
  eficiencia: {
    ...
    mensagensDuplicadasIgnoradas: 0, consultasCoalescidas: 0, bloqueiosCooldownDesdeVersao: 0, bloqueiosRateLimitDesdeVersao: 0,
    bloqueiosProximaConsultaDesdeVersao: 0, bloqueiosLockDesdeVersao: 0, proporcaoConsultaPorMensagem: 0.4,
  },
