...
import { registrarMensagemRecebida } from "@/lib/whatsappProviderState";
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Mensagem real recebida de um cliente — alimenta "última mensagem
    // recebida" do estado do provider (usado pelo admin e pelo monitoramento).
    // Best-effort: nunca impede o processamento da mensagem.
    registrarMensagemRecebida().catch(() => {});
