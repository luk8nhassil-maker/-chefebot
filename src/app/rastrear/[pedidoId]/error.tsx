...
export default function RastrearError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error("[rastrear] erro de renderização:", error)
  }, [error])
